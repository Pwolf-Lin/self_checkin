...
def get_env_str() -> str:
    ...
    arcadia_file = "/arcadia/config/config.sh"
    ...
    if os.getenv("GITHUB_ACTIONS"):
        ...
        env = "ql_new"
    elif os.path.exists(arcadia_file):
        print("成功，当前环境为: Arcadia")
        env = 'Arcadia'
...
def get_env_int() -> int:
    ...
    :return: 空: -1 / Windows: 0 / Linux: 1 / Darwin: 2 / github: 3 / v2p: 4 / ql: 5 / ql_new: 6 / arcadia: 7
    """
    env = get_env_str()
    if env == "Windows":
        return 0

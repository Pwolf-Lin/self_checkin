...
class Ctrip:
    ...
    def getMainCookie(Cookie,readerId):
        ...
        unionid= re.findall('"mpunionid":"(.*?)",',CK)[0]
        GUID = re.findall(r'GUID=(.*?);',CK)[1]
        vid = re.findall(r'"h5_vid":"(.*?)",',CK)[0]
        ouid = re.findall(r'"ouid":"(.*?)",',CK)[0]
    ...
    def doCash(mainCK):
        cashmsg=""
        cookie='Union=OUID=' + mainCK['ouid']+ '&'+ 'AllianceID='+ mainCK['AID']+'&'+'SID='+ mainCK['SID'] +'&'+ 'SourceID='+ mainCK['SourceID']+';'+'DUID='+mainCK['DUID']+';'+'GUID='+ mainCK["GUID"]+';'
        headers={
            "Cookie":cookie,
            "Host": "m.ctrip.com",
            "Connection": "keep-alive",
            ...
            "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.47(0x18002f2c) NetType/WIFI Language/zh_CN",
            "Referer": "https://servicewechat.com/wx0e6ed4f51db9d078/870/page-frame.html"
        }
        ...
        "coordinate":{},
        "ext":{"cver":"9999.000","extra":"{\"getCardListRequest\":\"{\\\"ext\\\": {\\\"cver\\\": \\\"9999.000\\\"}}\"}"},
        "head": head
        }
        ...
        try:
            batchurl = "https://m.ctrip.com/restapi/soa2/22598/batchReceiveProjectTask?_fxpcqlniredt=" + mainCK['GUID']
    ...
    def main(self):
        ...
        for check_item in self.check_items:
            ...
            msg = f"{sign_msg}\n\n{cash_msg}"
            msg_all += msg + "\n\n"
            if(msg_all==''):msg_all="似乎cookie失效，请重新获取含member字符的url的cookie"
        return msg_all
